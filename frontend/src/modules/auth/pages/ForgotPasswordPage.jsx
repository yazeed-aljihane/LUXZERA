        ...
        <div className="auth-content flex flex-col gap-6">
          ...
          {step === 1 ? (
            <form onSubmit={handleRequestReset} className="auth-view flex flex-col items-center gap-4 text-left">
              ...
              <button type="submit" disabled={loading} className="auth-cta px-6 mx-auto border-none flex items-center justify-center mt-1 self-center max-w-fit">
            ...
            <form onSubmit={handleResetPassword} className="auth-view flex flex-col items-center gap-4 text-left">
              ...
              <button type="submit" disabled={loading || successMsg.includes("Redirecting")} className="auth-cta px-6 mx-auto border-none flex items-center justify-center mt-1 self-center max-w-fit">
